        			...
        			<ul id="nav" class="nav navbar-nav">
        				...
        				<div class="dropdown">
        					<button class="btn btn-primary dropdown-toggle" id="menu1" type="button" data-toggle="dropdown">Режиссеры
        						<span class="caret"></span></button>
        						<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
        							<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Все режиссеры</a></li>
        							<li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick='loadDoc("txt/addProducerForm.txt")'>Добавить режиссера</a></li>
        							<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Удалить режиссера</a></li>   
        						</ul>
        				</div>
        				</li>
        				<li>
